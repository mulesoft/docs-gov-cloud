...
[NOTE]
Mule runtime 4.3 has entered https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/versioning-back-support-policy.pdf[External Support]. 
