...
* Government Cloud supports the Mule 4.5 LTS release channel. The Mule 4.5 Edge release channel is not supported, as it is not FedRAMP approved. For more information, visit xref:mule-runtime::lts-edge-release-cadence.adoc[].
