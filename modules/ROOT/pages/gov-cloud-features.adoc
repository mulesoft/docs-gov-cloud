...
For a detailed list of components and support information for each component by control plane, refer to xref:general::intro-platform-hosting#support-matrix-for-control-plane-hosting-options[Support Matrix for Control Plane Hosting Options].
