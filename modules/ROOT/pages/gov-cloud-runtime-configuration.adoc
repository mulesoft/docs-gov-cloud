...
You can configure Mule runtime engine (Mule) using `wrapper.conf`, the command line, or MuleSoft Government Cloud.
...
----
[NOTE]
Analytics are not currently available.
...
When deploying to MuleSoft Government Cloud, include the following properties in the Properties tab:
...
When deploying to MuleSoft Government Cloud, you must add the following information and enable the autodiscovery feature in the Properties tab. 
