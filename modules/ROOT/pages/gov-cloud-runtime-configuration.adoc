...
To use Mule runtime engine within the Government Cloud, you must redefine the configuration properties that enable Mule runtime engine to point to the Government Cloud. You must also provide the client ID and client secret of the environment belonging to your organization.

By default, Mule runtime engine is configured to point to the US control plane. If you do not override these properties, the API Gateway capability of Mule runtime engine is disabled in the Government Cloud.
