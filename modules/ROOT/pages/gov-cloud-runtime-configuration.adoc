...
By default, the Mule Runtime is configured to point to the US control plane. If you do not override these properties, the API Gateway capability of the Mule Runtime is disabled in the EU control plane.
