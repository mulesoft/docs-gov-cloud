...
When you purchase Government Cloud, your Customer Success Manager sends you onboarding instructions and access to the https://support.mulesoft.com/s/[MulesSoft Support Portal].
