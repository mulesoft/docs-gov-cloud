...
Once configured, Government Cloud works with your identity provider (IdP) to enable single sign-on (SSO) for users in your agency. Instead of using the Anypoint Platform sign-in page, your users sign in to the SSO system to access Anypoint Platform.

To configure your IdP to work with Government Cloud:

. Verify that you have access to the https://support.mulesoft.com/s/[MulesSoft Support Portal].
+
