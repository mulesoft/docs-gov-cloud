...
When you purchase Government Cloud, your Customer Success Manager sends you onboarding instructions and access to the https://help.mulesoft.com/s/[MulesSoft Help Center].
