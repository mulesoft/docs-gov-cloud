...
Mule 4 connectors that are verified for FIPS compliance can be found in Anypoint Exchange at https://anypoint.mulesoft.com/exchange/?search=tag:%22fips-140-verified%22&type=connector&type=extension[Assets provided by MuleSoft].

The following modules are FIPS compliant:	

* https://docs.mulesoft.com/compression-module/latest/[Compression]	
* xref:mule-runtime::cryptography.adoc[Crypto]	
* https://docs.mulesoft.com/java-module/latest/[Java]	
* https://docs.mulesoft.com/json-module/latest/[JSON]	
* https://docs.mulesoft.com/oauth-module/latest/oauth-module-reference[OAuth]	
* https://docs.mulesoft.com/oauth2-provider-module/latest/oauth2-provider-module-reference[OAuth2 Provider]	
* https://docs.mulesoft.com/scripting-module/latest/[Scripting]	
* https://docs.mulesoft.com/spring-module/latest/[Spring]	
* https://docs.mulesoft.com/validation-connector/latest/[Validation]	
* https://docs.mulesoft.com/xml-module/latest/[XML]
